...
async def list_challenges(
    ...
    return await api.get(
        "/challenges", params={"activeOnly": active_only, "skip": skip, "limit": limit}
    )
...
async def delete_challenge(challenge_id: str) -> None:
    ...
    require_scope("write")
    return await api.delete(f"/challenges/{challenge_id}")
...
async def unassign_challenge(member_id: str, challenge_id: str) -> None:
    ...
    require_scope("write")
    return await api.delete(f"/members/{member_id}/challenges/{challenge_id}")
...
async def assign_challenge_to_segment(challenge_id: str, segment_id: str) -> Dict[str, Any]:
    ...
    require_scope("write")
    return await api.post(
        f"/challenges/{challenge_id}/assign-segment", {"segment_id": segment_id}
    )
