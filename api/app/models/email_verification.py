...
class EmailVerificationCode(Base):
    ...
    # Which email the member was sent for this code (a typed code vs. a link to
    # the client's /verify page). Only the hash of the code is stored, so the
    # page link can never be rebuilt after the fact - a trigger asking for a
    # different type than the live code has to issue a new code.
